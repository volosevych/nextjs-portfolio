...
const services = [
  {
    ...
    description:
      "Custom, responsive websites built with modern front-end technologies like HTML, Tailwind CSS, JavaScript, React, and Next.js. Designed for performance and scalability.",
    href: "/contact",
  },
  {
    num: "02",
